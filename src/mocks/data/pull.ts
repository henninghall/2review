...
const pull = {
  url: "https://api.github.com/repos/care/api/pulls/629",
  id: 1058662561,
  node_id: "PR_kwDOGMjCY84_Geih",
  html_url: "https://github.com/care/api/pull/629",
  diff_url: "https://github.com/care/api/pull/629.diff",
  patch_url: "https://github.com/care/api/pull/629.patch",
  issue_url: "https://api.github.com/repos/care/api/issues/629",
  number: 629,
  state: "open",
  locked: false,
  ...
  labels: [
    {
      ...
      url: "https://api.github.com/repos/care/api/labels/dependencies",
      name: "dependencies",
      color: "0366d6",
      default: false,
  ...
  milestone: null,
  draft: false,
  commits_url: "https://api.github.com/repos/care/api/pulls/629/commits",
  review_comments_url:
    "https://api.github.com/repos/care/api/pulls/629/comments",
  review_comment_url:
    "https://api.github.com/repos/care/api/pulls/comments{/number}",
  comments_url: "https://api.github.com/repos/care/api/issues/629/comments",
  statuses_url:
    "https://api.github.com/repos/care/api/statuses/b3ff76a91d8a6efa146292afc9a28ea12f5eea0f",
  head: {
    ...
    user: {
      ...
      gravatar_id: "",
      url: "https://api.github.com/users/care",
      html_url: "https://github.com/care",
      followers_url: "https://api.github.com/users/care/followers",
      following_url: "https://api.github.com/users/care/following{/other_user}",
      gists_url: "https://api.github.com/users/care/gists{/gist_id}",
      starred_url: "https://api.github.com/users/care/starred{/owner}{/repo}",
      subscriptions_url: "https://api.github.com/users/care/subscriptions",
      organizations_url: "https://api.github.com/users/care/orgs",
      repos_url: "https://api.github.com/users/care/repos",
      events_url: "https://api.github.com/users/care/events{/privacy}",
      received_events_url: "https://api.github.com/users/care/received_events",
      type: "Organization",
      site_admin: false,
    },
    repo: {
      ...
      owner: {
        ...
        followers_url: "https://api.github.com/users/care/followers",
        following_url:
          "https://api.github.com/users/care/following{/other_user}",
        gists_url: "https://api.github.com/users/care/gists{/gist_id}",
        starred_url: "https://api.github.com/users/care/starred{/owner}{/repo}",
        subscriptions_url: "https://api.github.com/users/care/subscriptions",
        organizations_url: "https://api.github.com/users/care/orgs",
        ...
        events_url: "https://api.github.com/users/care/events{/privacy}",
        received_events_url:
          "https://api.github.com/users/care/received_events",
        type: "Organization",
        site_admin: false,
      },
      html_url: "https://github.com/care/api",
      description: " main API",
      fork: false,
      url: "https://api.github.com/repos/care/api",
      forks_url: "https://api.github.com/repos/care/api/forks",
      keys_url: "https://api.github.com/repos/care/api/keys{/key_id}",
      collaborators_url:
        "https://api.github.com/repos/care/api/collaborators{/collaborator}",
      teams_url: "https://api.github.com/repos/care/api/teams",
      hooks_url: "https://api.github.com/repos/care/api/hooks",
      issue_events_url:
        "https://api.github.com/repos/care/api/issues/events{/number}",
      events_url: "https://api.github.com/repos/care/api/events",
      assignees_url: "https://api.github.com/repos/care/api/assignees{/user}",
      branches_url: "https://api.github.com/repos/care/api/branches{/branch}",
      tags_url: "https://api.github.com/repos/care/api/tags",
      blobs_url: "https://api.github.com/repos/care/api/git/blobs{/sha}",
      git_tags_url: "https://api.github.com/repos/care/api/git/tags{/sha}",
      git_refs_url: "https://api.github.com/repos/care/api/git/refs{/sha}",
      trees_url: "https://api.github.com/repos/care/api/git/trees{/sha}",
      statuses_url: "https://api.github.com/repos/care/api/statuses/{sha}",
      languages_url: "https://api.github.com/repos/care/api/languages",
      stargazers_url: "https://api.github.com/repos/care/api/stargazers",
      contributors_url: "https://api.github.com/repos/care/api/contributors",
      subscribers_url: "https://api.github.com/repos/care/api/subscribers",
      subscription_url: "https://api.github.com/repos/care/api/subscription",
      commits_url: "https://api.github.com/repos/care/api/commits{/sha}",
      git_commits_url:
        "https://api.github.com/repos/care/api/git/commits{/sha}",
      comments_url: "https://api.github.com/repos/care/api/comments{/number}",
      issue_comment_url:
        "https://api.github.com/repos/care/api/issues/comments{/number}",
      contents_url: "https://api.github.com/repos/care/api/contents/{+path}",
      compare_url:
        "https://api.github.com/repos/care/api/compare/{base}...{head}",
      merges_url: "https://api.github.com/repos/care/api/merges",
      archive_url:
        "https://api.github.com/repos/care/api/{archive_format}{/ref}",
      downloads_url: "https://api.github.com/repos/care/api/downloads",
      issues_url: "https://api.github.com/repos/care/api/issues{/number}",
      pulls_url: "https://api.github.com/repos/care/api/pulls{/number}",
      milestones_url:
        "https://api.github.com/repos/care/api/milestones{/number}",
      notifications_url:
        "https://api.github.com/repos/care/api/notifications{?since,all,participating}",
      labels_url: "https://api.github.com/repos/care/api/labels{/name}",
      releases_url: "https://api.github.com/repos/care/api/releases{/id}",
      deployments_url: "https://api.github.com/repos/care/api/deployments",
      created_at: "2021-10-11T06:51:16Z",
      updated_at: "2022-08-29T12:25:00Z",
      pushed_at: "2022-09-19T10:39:43Z",
      git_url: "git://github.com/care/api.git",
      ssh_url: "git@github.com:care/api.git",
      clone_url: "https://github.com/care/api.git",
      svn_url: "https://github.com/care/api",
      homepage: "",
      size: 7632,
      stargazers_count: 2,
      watchers_count: 2,
  ...
  _links: {
    self: {
      href: "https://api.github.com/repos/care/api/pulls/629",
    },
    html: {
      href: "https://github.com/care/api/pull/629",
    },
    issue: {
      href: "https://api.github.com/repos/care/api/issues/629",
    },
    comments: {
      href: "https://api.github.com/repos/care/api/issues/629/comments",
    },
    review_comments: {
      href: "https://api.github.com/repos/care/api/pulls/629/comments",
    },
    review_comment: {
      href: "https://api.github.com/repos/care/api/pulls/comments{/number}",
    },
    commits: {
      href: "https://api.github.com/repos/care/api/pulls/629/commits",
    },
    statuses: {
      href: "https://api.github.com/repos/care/api/statuses/b3ff76a91d8a6efa146292afc9a28ea12f5eea0f",
    },
  },
